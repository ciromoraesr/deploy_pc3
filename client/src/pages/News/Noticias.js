...
function Noticias(){
    ...
    useEffect(() =>{
      ...
      const sendNews = async() => {
        try {
          ...
          const response  = await axios.post(`https://deploy-pc3-server.vercel.app/noticias/`,  newsData );
    ...
    useEffect(() => {
      const fetchNoticias = async () => {
        console.log(tag);
        try {
          const response = await axios.get(`https://deploy-pc3-server.vercel.app/noticias`, {
            params: {
              page: currentPage,
              limit: 4,
              tag: tag,
